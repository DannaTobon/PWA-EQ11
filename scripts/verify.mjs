...
for (const [id, args] of [["test", ["test"]], ["vitest", ["run", "test:manifest"]], ["build", ["run", "build"]]]) {
  console.log(`\nVerificando ${id}...`);
